    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.menus.index') }}" class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white">Voltar para Pratos</a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.update', $menu->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            <label for="name" class="block text-sm font-medium text-gray-700"> Prato </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="body" rows="3" name="description" class="shadow-sm focus:ring-red-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ $menu->description }}</textarea>
                            </div>
                            @error('description')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mt-6 p-4 bg-green-600">
                            <button type="submit" class="px-4 py-2 bg-red-500 hover:bg-black hover:text-white rounded">Atualizar</button>
                        </div>
                    </form>
                </div>
