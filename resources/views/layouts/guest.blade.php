    ...
    <div class="bg-white shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                <a class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-red-500 md:text-2xl hover:text-green-600" href="#">
                    Bandejão IFSP
                </a>
                <!-- Mobile menu button -->
            ...
            <div :class="isOpen ? 'flex' : 'hidden'" class="flex-col mt-8 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0">
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-red-500 hover:text-green-600" href="#">Home</a>
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-red-500 hover:text-green-600" href="#">Sobre nós</a>
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-red-500 hover:text-green-600" href="#">Nossos pratos</a>
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-red-500 hover:text-green-600" href="#">Faça sua reserva</a>
            </div>
        </nav>
    </div>
