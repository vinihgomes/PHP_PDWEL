<x-guest-layout>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        <h3 class="text-xl">Nossa história
                        </h3>
                        <h2 class="text-4xl text-green-600">Bem vindo!</h2>
                        <!-- </h1> -->
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                            Desesperado por me formar, fiz este pequeno projeto visando bom aproveitamento das aulas do professor Ugo, que seria a aplicação de um restaurante, onde é possível cadastrar pratos, categorias, novas mesas (painel admin) e fazer reservas (usuário comum). Aproveitei alguns recursos conhecidos, como o querido Bandejão do IFSP, aproveitando o cardápio do mesmo.
                        </p>
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="https://img.estadao.com.br/fotos/crop/1200x675/resources/jpg/4/7/1463093945674.jpg" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        <h2 class="mb-4 text-2xl font-bold">Ainda sobre nós</h2>
                        <h2 class="mb-4 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                            Por quê nos escolher?</h2>

                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">Como bom IFSPiano, sabemos a importância do Bandejão para que os alunos consigam almoçar e jantar com bons preços, ao invés de pagar 5,00 no salgado ruim da cantina.</p>
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Ta rodando tudo em PHP</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">É baratinho</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="font-medium text-gray-500">100% garantido encontrar alguns cabelos na comida</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        <div class="my-16 text-center">
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                Depoimentos </h2>
            <p class="text-xl text-white">Depoimentos de quem passou por aqui e não quer passar mais</p>
        </div>
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Projeto</h2>
                    <p class="mt-2 text-gray-600">Se a comida é boa eu não sei, mas que perdi uns cabelos nesse projeto, eu perdi</p>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Equipe de desenvolvimento</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                ...
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Muito bom</h2>
                    <p class="mt-2 text-gray-600">Adoro o bandejão porque tem opções veganas para que todos possam se alimentar (salada de alface)</p>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Pessoal do grupo do IFSP</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full" src="https://veja.abril.com.br/wp-content/uploads/2020/04/ana-maria-braga-2018-0614.jpg.jpg">
                </div>
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Hmmmm</h2>
                    <p class="mt-2 text-gray-600">Solta os cachorro!!!</p>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Ana Maria Braga</a>
                </div>
            </div>
        </div>
    </section>
